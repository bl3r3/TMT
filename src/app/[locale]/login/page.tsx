        ...
        <div className="flex flex-col justify-center p-6 md:p-10">
          <div className="mb-8 text-center md:text-left">
            <Image
              ...
              className="mx-auto"
            />
            <h1 className="mt-6 text-4xl font-extrabold text-indigo-700 leading-tight">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link
              href={`/${locale}`}
              className="inline-flex items-center justify-center rounded-xl px-4 py-2.5 text-sm font-medium text-violet-500 hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-violet-400 animate__animated animate__backInUp animate__delay-3s"
            >
              {t("cta")}
            </Link>
